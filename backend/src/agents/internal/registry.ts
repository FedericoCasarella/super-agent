...
import chiefOfStaff from './chief_of_staff.js';
import { sendTelegram } from '../../telegram/bot.js';

const REGISTRY: InternalAgent[] = [brainClassifier, linkWeaver, peopleAnalyzer, vaultDreamer, vaultLibrarian, vaultGardener, thoughtDigest, chiefOfStaff];
